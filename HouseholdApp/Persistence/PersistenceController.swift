...
let cloudKitContainerID = "iCloud.com.householdapp.app"
...
struct PersistenceController {
    ...
    private static let privateStoreURL: URL = {
        ...
        return dir.appendingPathComponent("HouseholdApp-Private.sqlite")
    }()

    private static let sharedStoreURL: URL = {
        let dir = NSPersistentContainer.defaultDirectoryURL()
        return dir.appendingPathComponent("HouseholdApp-Shared.sqlite")
    }()

    // ── Init ───────────────────────────────────────────────────────────────────
    init(inMemory: Bool = false) {
        container = NSPersistentCloudKitContainer(name: "HouseholdApp")
    ...
    private func createShare(for object: NSManagedObject) async throws -> CKShare {
        ...
        share[CKShare.SystemFieldKey.title] = "HouseholdApp Household" as CKRecordValue
        share[CKShare.SystemFieldKey.shareType] = "com.householdapp.household" as CKRecordValue
